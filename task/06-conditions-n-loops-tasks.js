...
function getDigitalRoot(n) {
    return n<10 ? n : getDigitalRoot((''+n).split('').reduce((r,e) => r+e*1, 0))
}
...
function isBracketsBalanced(str) {
    ...
    for (let i in str) {
        let s = str[i];
        let opn = !!~opens.indexOf(s);
        let cls = !!~closes.indexOf(s);
        if (opn) {
            stack.push(s);
        } else {
...
function evaluateTicTacToePosition(position) {
    ...
    if (position[0][0]==position[0][1] && position[0][1]==position[0][2] && position[0][0] != undefined) res = position[0][0];
    if (position[1][0]==position[1][1] && position[1][1]==position[1][2] && position[1][0] != undefined) res = position[1][0];
    if (position[2][0]==position[2][1] && position[2][1]==position[2][2] && position[2][0] != undefined) res = position[2][0];

    if (position[0][0]==position[1][0] && position[1][0]==position[2][0] && position[0][0] != undefined) res = position[0][0];
    if (position[0][1]==position[1][1] && position[1][1]==position[2][1] && position[0][1] != undefined) res = position[0][1];
    if (position[0][2]==position[1][2] && position[1][2]==position[2][2] && position[0][2] != undefined) res = position[0][2];

    if (position[0][0]==position[1][1] && position[1][1]==position[2][2] && position[0][0] != undefined) res = position[0][0];
    if (position[2][0]==position[1][1] && position[1][1]==position[0][2] && position[2][0] != undefined) res = position[2][0];
