...
function encodeToRot13(str) {
  let abc = ['ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz', 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm'];
  let res = '';
  for (let i=0; i<str.length; i++) {
      if (abc[0].indexOf(str[i]) > -1)
          res += abc[1][abc[0].indexOf(str[i])];
      else
          res += str[i];
  }
  return res;
